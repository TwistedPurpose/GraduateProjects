...
GO
PRINT N'Creating [dbo].[ItemSession]...';
...
CREATE TABLE [dbo].[ItemSession] (
    [ItemId]    INT NOT NULL,
    [SessionId] INT NOT NULL,
    CONSTRAINT [PK_ItemSessions] PRIMARY KEY CLUSTERED ([ItemId] ASC, [SessionId] ASC)
);
...
CREATE TABLE [dbo].[CampaignSessions] (
    [CampaignId] INT NOT NULL,
    [SessionId]  INT NOT NULL,
    CONSTRAINT [PK_CampaignSessions] PRIMARY KEY CLUSTERED ([CampaignId] ASC, [SessionId] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_Items_ToCampaign]...';


GO
ALTER TABLE [dbo].[Items]
    ADD CONSTRAINT [FK_Items_ToCampaign] FOREIGN KEY ([CampaignId]) REFERENCES [dbo].[Campaign] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Items_Session_ItemId]...';


GO
ALTER TABLE [dbo].[ItemSession]
    ADD CONSTRAINT [FK_Items_Session_ItemId] FOREIGN KEY ([ItemId]) REFERENCES [dbo].[Items] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Items_Session_SessionId]...';


GO
ALTER TABLE [dbo].[ItemSession]
    ADD CONSTRAINT [FK_Items_Session_SessionId] FOREIGN KEY ([SessionId]) REFERENCES [dbo].[Session] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Campaign_Session_CampaignId]...';


GO
ALTER TABLE [dbo].[CampaignSessions]
    ADD CONSTRAINT [FK_Campaign_Session_CampaignId] FOREIGN KEY ([CampaignId]) REFERENCES [dbo].[Campaign] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Campaign_Session_SessionId]...';


GO
ALTER TABLE [dbo].[CampaignSessions]
    ADD CONSTRAINT [FK_Campaign_Session_SessionId] FOREIGN KEY ([SessionId]) REFERENCES [dbo].[Session] ([Id]);
