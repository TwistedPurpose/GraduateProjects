...
GO
EXECUTE sp_addrolemember @rolename = N'db_datareader', @membername = N'GMPlanner';
...
GO
EXECUTE sp_addrolemember @rolename = N'db_datawriter', @membername = N'GMPlanner';
...
CREATE TABLE [dbo].[CharacterSessions] (
    ...
    [SessionId]   INT NOT NULL,
    PRIMARY KEY CLUSTERED ([CharacterId] ASC, [SessionId] ASC)
);
